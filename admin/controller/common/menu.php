...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_vendor_type'] = $this->language->get('text_vendor_type');
		...
		$data['text_ceremony'] = $this->language->get('text_ceremony');
		...
		$data['text_report_transaction_balance'] = $this->language->get('text_report_transaction_balance');
		...
		$data['vendor'] = $this->url->link('catalog/vendor', 'token=' . $this->session->data['token'], true);
		$data['vendor_type'] = $this->url->link('catalog/vendor_type', 'token=' . $this->session->data['token'], true);
		...
		$data['slot'] = $this->url->link('localisation/slot', 'token=' . $this->session->data['token'], true);
		$data['ceremony'] = $this->url->link('localisation/ceremony', 'token=' . $this->session->data['token'], true);
		...
		$data['order'] = $this->url->link('sale/order/yearView', 'token=' . $this->session->data['token'], true);
		...
		$data['report_transaction_balance'] = $this->url->link('report/transaction_balance', 'token=' . $this->session->data['token'], true);
		...
		$data['account'] = $this->url->link('accounting/account', 'token=' . $this->session->data['token'], true);
		$data['balance'] = $this->url->link('accounting/balance', 'token=' . $this->session->data['token'], true);
		$data['expense'] = $this->url->link('accounting/expense', 'token=' . $this->session->data['token'], true);
		$data['transaction'] = $this->url->link('accounting/transaction', 'token=' . $this->session->data['token'], true);
