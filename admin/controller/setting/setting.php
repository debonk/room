...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['deposit'])) {
			$data['error_deposit'] = $this->error['deposit'];
		} else {
			$data['error_deposit'] = '';
		}
	...
	protected function validate() {
		...
		if ($this->request->post['config_deposit'] < 0) {
			$this->error['limit_deposit'] = $this->language->get('error_deposit');
		}
