...
class ControllerCustomerCustomer extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_id_no'] = $this->language->get('entry_id_no');
		$data['entry_email'] = $this->language->get('entry_email');
		...
		$data['entry_profession'] = $this->language->get('entry_profession');
		...
		if (isset($this->error['id_no'])) {
			$data['error_id_no'] = $this->error['id_no'];
		} else {
			$data['error_id_no'] = '';
		}
		...
		if (isset($this->request->post['id_no'])) {
			$data['id_no'] = $this->request->post['id_no'];
		} elseif (!empty($customer_info)) {
			$data['id_no'] = $customer_info['id_no'];
		} else {
			$data['id_no'] = '';
		}
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['id_no']) < 12) || (utf8_strlen(trim($this->request->post['id_no'])) > 24)) {
			$this->error['id_no'] = $this->language->get('error_id_no');
		}
