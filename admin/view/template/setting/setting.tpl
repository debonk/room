      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-order-update" data-toggle="tab"><?php echo $tab_order_update; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
                <legend><?php echo $text_reference_number; ?></legend>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-receipt-customer-prefix"><?php echo $entry_receipt_customer_prefix; ?></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_receipt_customer_prefix" value="<?php echo $config_receipt_customer_prefix; ?>" placeholder="<?php echo $entry_receipt_customer_prefix; ?>" id="input-receipt-customer-prefix" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-receipt-vendor-prefix"><?php echo $entry_receipt_vendor_prefix; ?></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_receipt_vendor_prefix" value="<?php echo $config_receipt_vendor_prefix; ?>" placeholder="<?php echo $entry_receipt_vendor_prefix; ?>" id="input-receipt-vendor-prefix" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-agreement-vendor-prefix"><?php echo $entry_agreement_vendor_prefix; ?></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_agreement_vendor_prefix" value="<?php echo $config_agreement_vendor_prefix; ?>" placeholder="<?php echo $entry_agreement_vendor_prefix; ?>" id="input-agreement-vendor-prefix" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-admission-vendor-prefix"><?php echo $entry_admission_vendor_prefix; ?></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_admission_vendor_prefix" value="<?php echo $config_admission_vendor_prefix; ?>" placeholder="<?php echo $entry_admission_vendor_prefix; ?>" id="input-admission-vendor-prefix" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane" id="tab-order-update">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-notification-start"><span data-toggle="tooltip" title="<?php echo $help_notification_start; ?>"><?php echo $entry_notification_start; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_notification_start" value="<?php echo $config_notification_start; ?>" placeholder="<?php echo $entry_notification_start; ?>" id="input-notification-start" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-initial-payment-status"><span data-toggle="tooltip" title="<?php echo $help_initial_payment_status; ?>"><?php echo $entry_initial_payment_status; ?></span></label>
                <div class="col-sm-10">
                  <select name="config_initial_payment_status_id" id="input-initial-payment-status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-initial-payment-amount"><?php echo $entry_initial_payment_amount; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_initial_payment_amount" value="<?php echo $config_initial_payment_amount; ?>" placeholder="<?php echo $entry_initial_payment_amount; ?>" id="input-initial-payment-amount" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-initial-payment-limit"><span data-toggle="tooltip" title="<?php echo $help_initial_payment_limit; ?>"><?php echo $entry_initial_payment_limit; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_initial_payment_limit" value="<?php echo $config_initial_payment_limit; ?>" placeholder="<?php echo $entry_initial_payment_limit; ?>" id="input-initial-payment-limit" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-down-payment-status"><span data-toggle="tooltip" title="<?php echo $help_down_payment_status; ?>"><?php echo $entry_down_payment_status; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-down-payment-amount"><?php echo $entry_down_payment_amount; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_down_payment_amount" value="<?php echo $config_down_payment_amount; ?>" placeholder="<?php echo $entry_down_payment_amount; ?>" id="input-down-payment-amount" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-down-payment-limit"><span data-toggle="tooltip" title="<?php echo $help_down_payment_limit; ?>"><?php echo $entry_down_payment_limit; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_down_payment_limit" value="<?php echo $config_down_payment_limit; ?>" placeholder="<?php echo $entry_down_payment_limit; ?>" id="input-down-payment-limit" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-full-payment-status"><span data-toggle="tooltip" title="<?php echo $help_full_payment_status; ?>"><?php echo $entry_full_payment_status; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-full-payment-limit"><span data-toggle="tooltip" title="<?php echo $help_full_payment_limit; ?>"><?php echo $entry_full_payment_limit; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_full_payment_limit" value="<?php echo $config_full_payment_limit; ?>" placeholder="<?php echo $entry_full_payment_limit; ?>" id="input-full-payment-limit" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-event-status"><?php echo $entry_event_status; ?></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_status_with_payment; ?>"><?php echo $entry_status_with_payment; ?></span></label>
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <div class="checkbox">
                      <label>
                        ...
                        <input type="checkbox" name="config_status_with_payment[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" />
                        <?php echo $order_status['name']; ?>
                        <?php } else { ?>
                        <input type="checkbox" name="config_status_with_payment[]" value="<?php echo $order_status['order_status_id']; ?>" />
                        <?php echo $order_status['name']; ?>
                        <?php } ?>
                      </label>
                    </div>
