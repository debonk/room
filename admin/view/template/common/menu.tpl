<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a class="parent"><?php echo $text_vendor; ?></a>
        <ul>
          <li><a href="<?php echo $vendor; ?>"><?php echo $text_vendor; ?></a></li>
          <li><a href="<?php echo $vendor_type; ?>"><?php echo $text_vendor_type; ?></a></li>
        </ul>
      </li>
  ...
  <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_reports; ?></span></a>
    <ul>
      ...
      <li><a class="parent"><?php echo $text_accounting; ?></a>
        <ul>
          <li><a href="<?php echo $report_transaction_balance; ?>"><?php echo $text_report_transaction_balance; ?></a></li>
        </ul>
      </li>
    </ul>
  </li>
    ...
    <ul>
      ...
      <li><a class="parent"><?php echo $text_localisation; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $slot; ?>"><?php echo $text_slot; ?></a></li>
          <li><a href="<?php echo $ceremony; ?>"><?php echo $text_ceremony; ?></a></li>
