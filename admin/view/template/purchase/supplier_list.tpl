          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-supplier-name"><?php echo $entry_supplier_name; ?></label>
                <input type="text" name="filter_supplier_name" value="<?php echo $filter_supplier_name; ?>" placeholder="<?php echo $entry_supplier_name; ?>" id="input-supplier-name" class="form-control" />
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-supplier-type"><?php echo $entry_vendor_type; ?></label>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'v.supplier_name') { ?>
                    <a href="<?php echo $sort_supplier_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_supplier_name; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_supplier_name; ?>"><?php echo $column_supplier_name; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($supplier['supplier_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $supplier['supplier_name']; ?></td>
                  <td class="text-left"><?php echo $supplier['vendor_type']; ?></td>
                  <td class="text-left"><?php echo $supplier['telephone']; ?></td>
                  <td class="text-left"><?php echo $supplier['email']; ?></td>
                  <td class="text-right"><?php echo $supplier['balance']; ?></td>
                  <td class="text-left"><?php echo $supplier['status']; ?></td>
                  <td class="text-left"><?php echo $supplier['date_added']; ?></td>
...
$('#button-filter').on('click', function() {
	...
	var filter_supplier_name = $('input[name=\'filter_supplier_name\']').val();
