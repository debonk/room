          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-supplier-name"><?php echo $entry_supplier_name; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="supplier_name" value="<?php echo $supplier_name; ?>" placeholder="<?php echo $entry_supplier_name; ?>" id="input-supplier-name" class="form-control" />
                  <?php if ($error_supplier_name) { ?>
                  <div class="text-danger"><?php echo $error_supplier_name; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-supplier-type"><?php echo $entry_vendor_type; ?></label>
                <div class="col-sm-10">
                  <select name="vendor_type_id" id="input-supplier-type" class="form-control">
				   <option value=""><?php echo $text_not_vendor; ?></option>
...
$('#transaction').load('index.php?route=purchase/supplier/transaction&token=<?php echo $token; ?>&supplier_id=<?php echo $supplier_id; ?>');
//--></script></div>
<?php echo $footer; ?>