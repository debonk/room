						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								<input type="text" name="filter[reference]" value="<?php echo $filter['reference']; ?>"
									placeholder="<?php echo $entry_reference; ?>" id="input-reference-no" class="form-control" />
							</div>
							<div class="form-group">
					...
					<table class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<?php } ?>
								<td class="text-left">
									<?php echo $transaction['account_debit']; ?>
								</td>
								<td class="text-left">
									<?php echo $transaction['account_credit']; ?>
								</td>
								<td class="text-left">
								...
								<td class="text-right"><a href="<?php echo $transaction['edit']; ?>" data-toggle="tooltip"
										title="<?php echo $button_edit; ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i></a>
								</td>
							</tr>
							<?php } ?>
							<?php } else { ?>
