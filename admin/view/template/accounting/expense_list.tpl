      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label class="control-label" for="input-account-from"><?php echo $entry_asset; ?></label>
              ...
              <div class="form-group">
                <label class="control-label" for="input-account-to"><?php echo $entry_expense; ?></label>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?php echo $sort_account_from; ?>" class="<?php echo $sort == 'account_from' ? strtolower($order) : ''; ?>"><?php echo $column_asset; ?></a>
                    <i class="fa fa-long-arrow-right"></i>
					<a href="<?php echo $sort_account_to; ?>" class="<?php echo $sort == 'account_to' ? strtolower($order) : ''; ?>"><?php echo $column_expense; ?></a>
				  </td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=accounting/expense&token=<?php echo $token; ?>';
