      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-transaction" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-account-from"><?php echo $entry_asset; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-account-to"><?php echo $entry_expense; ?></label>
            <div class="col-sm-10">
