      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-6 col-md-3">
              <div class="form-group">
                <label class="control-label" for="input-account-from"><?php echo $entry_account_from; ?></label>
                <select name="filter_account_from_id" id="input-account-from" class="form-control">
                  <option value="*"><?php echo $text_all; ?></option>
                  <?php if ($filter_account_from_id == '0') { ?>
              ...
              <div class="form-group">
                <label class="control-label" for="input-account-to"><?php echo $entry_account_to; ?></label>
                <select name="filter_account_to_id" id="input-account-to" class="form-control">
                  <option value="*"><?php echo $text_all; ?></option>
                  <?php if ($filter_account_to_id == '0') { ?>
                  <option value="0" selected="selected"><?php echo $text_none; ?></option>
                  <?php } else { ?>
                  <option value="0"><?php echo $text_none; ?></option>
                  <?php } ?>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?php echo $sort_account_from; ?>" class="<?php echo $sort == 'account_from' ? strtolower($order) : ''; ?>"><?php echo $column_account_from; ?></a>
                    <i class="fa fa-long-arrow-right"></i>
					<a href="<?php echo $sort_account_to; ?>" class="<?php echo $sort == 'account_to' ? strtolower($order) : ''; ?>"><?php echo $column_account_to; ?></a>
				  </td>
              ...
              <tbody>
                ...
                <tr <?php echo $transaction['uncomplete'] ? 'class="danger"' : ''; ?>>
				  ...
				  <?php if ($transaction['unlock']) { ?>
                    <button type="button" id="btn-lock-toggle<?php echo $transaction['transaction_id']; ?>" value="<?php echo $transaction['transaction_id']; ?>" class="btn btn-sm btn-warning" data-toggle="tooltip" title="<?php echo $button_edit_lock; ?>"><i class="fa fa-unlock-alt"></i></button>
                    <?php } else { ?>
                    <button type="button" id="btn-lock-toggle<?php echo $transaction['transaction_id']; ?>" value="<?php echo $transaction['transaction_id']; ?>" class="btn btn-sm btn-primary" data-toggle="tooltip" title="<?php echo $button_edit_unlock; ?>"><i class="fa fa-lock"></i></button>
                    <?php } ?>
				  <a href="<?php echo $transaction['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i></a>
				  </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
