...
<head>
<meta charset="UTF-8" />
<title><?php echo $title_admission; ?></title>
        ...
        <tbody>
          <tr>
            <td colspan="4" class="text-center">
	  		<h3 class="text-center"><?php echo $title_admission; ?></h3>
              <?php if ($invoice_no) { ?>
          ...
          <tr>
            <td style="width: 1%;"></td>
            <td style="width: 30%;"><?php echo $text_day_date; ?></td>
            <td style="width: 1%;">:</td>
            <td style="width: 68%;"><?php echo $event_date; ?></td>
          </tr>
          <tr>
          ...
          <tr>
            <td></td><td><?php echo $text_vendor_type; ?></td><td>:</td><td><?php echo $vendor_type; ?></td>
          </tr>
          <tr>
          ...
          <tr>
            <td></td><td><?php echo $text_contact_person; ?></td><td>:</td><td><?php echo $contact_person; ?></td>
          </tr>
          <tr>
            <td colspan="4" class="text-justify">
              <br /><?php echo $text_persiapan; ?>
            </td>
          </tr>
          <tr>
            <td></td><td><?php echo $text_day_date; ?></td><td>:</td><td><?php echo $preparation_date; ?></td>
          </tr>
          <tr>
            <td></td><td><?php echo $text_time; ?></td><td>:</td><td><?php echo $preparation_time; ?></td>
          </tr>
          <tr>
            <td colspan="4" class="text-justify">
              <br /><?php echo $text_demikian_2; ?><br />
            </td>
          </tr>
        </tbody>
      </table>
        ...
        <tbody>
          ...
          <tr>
            <td class="text-left" colspan="2">
              <br /><?php echo $text_catatan; ?><br />
            </td>
          </tr>
          <tr>
            <td class="text-left" colspan="2">
	  	    <ul>
              <li><?php echo $text_lampirkan; ?></li>
	  		</ul>
            </td>
          </tr>
        </tbody>
