...
<head>
	<meta charset="UTF-8" />
	<title>
		<?php echo $title_vendor_agreement; ?>
	</title>
...
<body>
	<div class="container">
		<?php if ($preview) { ?>
		<div id="background">
			<p class="bg-text" id="bg-vendor-agreement">
				<?php echo $text_mark; ?>
			</p>
		</div>
		<?php } ?>
					...
					<tbody>
						...
						<tr>
							<td colspan="4" class="text-justify">
								<br />
								<?php echo $text_ketentuan; ?>
								<br /><br />
								<?php echo $text_mohon_surat; ?>
								<br /><br />
								<?php echo $text_apabila_anda; ?>
								<?php if ($pay_deposit) { ?>
								<br /><br />
								<?php echo $text_uang_jaminan; ?>
								<br /><br />
								<?php echo $text_uang_dikembalikan . ' ' . $text_kerusakan; ?>
								<br /><br />
								<?php echo $text_silahkan_transfer; ?>
								<p class="text-center"><b>
										<?php echo $no_rekening; ?>
									</b></p>
								<?php } else { ?>
								<br /><br />
								<?php echo $text_kerusakan; ?><br />
								<?php } ?>
								<br />
							</td>
						</tr>
				...
				<table class="table table-application text-center page-content">
					<tbody>
						...
						<tr>
							...
							<td>
								<?php echo $text_menyetujui; ?><br /><br /><br /><br /><br /><br />
							</td>
						</tr>
						<tr>
							<td><u><b>
