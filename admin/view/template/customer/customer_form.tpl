                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                          ...
                          <?php if ($error_id_no) { ?>
                          <div class="text-danger"><?php echo $error_id_no; ?></div>
                          <?php } ?>
                        </div>
                      </div>
                      <div class="form-group required">
                    ...
                    <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-profession<?php echo $address_row; ?>"><?php echo $entry_profession; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="address[<?php echo $address_row; ?>][profession]" value="<?php echo $address['profession']; ?>" placeholder="<?php echo $entry_profession; ?>" id="input-profession<?php echo $address_row; ?>" class="form-control" />
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-position<?php echo $address_row; ?>"><?php echo $entry_position; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="address[<?php echo $address_row; ?>][position]" value="<?php echo $address['position']; ?>" placeholder="<?php echo $entry_position; ?>" id="input-position<?php echo $address_row; ?>" class="form-control" />
                        </div>
                      </div>
                      <div class="form-group required">
...
function addAddress() {
	...
	html += '  <div class="form-group">';
	html += '    <label class="col-sm-2 control-label" for="input-profession' + address_row + '"><?php echo $entry_profession; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][profession]" value="" placeholder="<?php echo $entry_profession; ?>" id="input-profession' + address_row + '" class="form-control" /></div>';
	html += '  </div>';

	html += '  <div class="form-group">';
	html += '    <label class="col-sm-2 control-label" for="input-position' + address_row + '"><?php echo $entry_position; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][position]" value="" placeholder="<?php echo $entry_position; ?>" id="input-position' + address_row + '" class="form-control" /></div>';
	html += '  </div>';
